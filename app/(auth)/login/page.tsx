...
export default function LoginPage(): JSX.Element {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-bgPrimary px-4 py-8 sm:px-6 sm:py-12">
      <Card className="w-full max-w-md">
        ...
        <div className="space-y-3">
          ...
          <div className="-mt-1 text-right">
            <Link href="/login" className="text-sm text-zinc-500 transition hover:text-textColor">
              Forgot Password?
            </Link>
          </div>
          ...
          <div className="pt-1 text-center">
            <Link href="/dealer-signup" className="text-sm text-zinc-500 transition hover:text-textColor">
              Dealer Signup
            </Link>
          </div>
        </div>
